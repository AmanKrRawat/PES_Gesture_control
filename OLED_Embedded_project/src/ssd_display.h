...
extern void create_menu_screen(void);
extern void create_game_screen(void);
extern void create_line_shape_screen(void);
extern void create_square_shape_screen(void);
extern void create_tick_shape_screen(void);
